...
export declare type AiEditorOptions = {
    ...
    poweredBy?: string | ((count: number) => string);
    ai?: AiGlobalConfig;
    outline?: {
        visible?: boolean;
...
export declare interface AiGlobalConfig {
    chatConfig?: {
        ...
        references?: AiPanelReference[];
        addReference?: (callback: (newRefs: AiPanelReference[]) => void) => void;
    };
    models?: {
...
declare abstract class AiModel {
    ...
    protected readonly defaultAiRole = "\u4F60\u662F\u4E00\u4E2A\u4E13\u4E1A\u7684 AI \u5199\u4F5C\u52A9\u624B\u4E14\u7CBE\u901A\u591A\u56FD\u8BED\u8A00\u4E92\u8BD1\uFF0C\u4F5C\u4E3A\u5168\u9886\u57DF\u521B\u4F5C\u603B\u76D1\uFF0C\u62E5\u670920\u591A\u5E74\u8DE8\u5B66\u79D1\u5199\u4F5C\u7ECF\u9A8C\uFF0C\u4F60\u7684\u4EFB\u52A1\u662F\u6839\u636E\u7528\u6237\u63D0\u4F9B\u7684\u5185\u5BB9\u548C\u8981\u6C42\uFF0C\u751F\u6210\u9AD8\u8D28\u91CF\u7684\u5BF9\u5E94\u9886\u57DF\u76F8\u5E94\u98CE\u683C\u7684\u5199\u4F5C\u5185\u5BB9\u3002";
    protected buildStructuredPrompt(selectedText: string, originalPrompt: string): string;
    /**
     * 创建客户端链接 URL
     */
...
declare interface AiPanelReference {
    title: string;
    content: string;
    link?: string;
}
...
declare class Footer extends HTMLElement implements AiEditorEventListener {
    count: number;
    poweredBy: string | ((count: number) => string) | undefined;
    draggable: boolean;
    constructor();
...
declare class OutlineView extends HTMLElement implements AiEditorEventListener {
    private editor?;
    private outlines;
    private options;
    private currentId;
    private _shadowRoot;
    private state;
    private indicatorContainerEl;
    private outlineListEl;
    ...
    private render;
    onCreate(props: EditorEvents['create'], options: AiEditorOptions): void;
    onTransaction({ transaction }: EditorEvents['transaction']): void;
    onEditableChange(): void;
    private createOutlineList;
    private createIndicators;
    private handleOutlineClick;
    private bindContentScrollHandler;
    private generateOutline;
    createOutlineView(): void;
    private fireScroll;
    onEvent(event: AiEditorEvent): void;
}
